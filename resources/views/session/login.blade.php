        ...
        <div class="container">
            <div class="row d-flex flex-column justify-content-center">
                ...
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <ol class="text-white">
                        <li>Username <b>Phone number</b> and Password <b>your password</b>
                        </li>
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
            ...
            <div class="card z-index-0">
                ...
                <form role="form" class="text-start" action="/session" method="POST">
                    @csrf
                    <div class="mb-3">
                    <input type="phone_no" class="form-control" placeholder="Phone" aria-label="Phone"  name="phone_no" id="phone_no" value="{{ old('phone_no') }}" required>
                    @error('phone_no')
