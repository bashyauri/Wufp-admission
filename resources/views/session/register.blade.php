                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form action="/register" method="POST" role="form text-start">
                                ...
                                <div>
                                    <div class=" ">
                                        <input type="text" class="form-control " placeholder="First Name" aria-label="First Name" aria-describedby="email-addon" name="first_name" id="first_name" value="{{ old('first_name') }}" required>
                                        @error('first_name')
                                ...
                                <div>
                                    <div class="mt-3 ">
                                        <input type="text" class="form-control " placeholder="Last Name" aria-label="Last Name" aria-describedby="email-addon" name="last_name" id="last_name" value="{{ old('last_name') }}" required>
                                        @error('last_name')
                                            <p class="text-danger text-xs mt-2 mb-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div>
                                    <div class="mt-3">
                                        <input type="text" class="form-control " placeholder="Middle Name" aria-label="Middle Name" aria-describedby="email-addon" name="middle_name" id="middle_name" value="{{ old('middle_name') }}">
                                        @error('middle_name')
                                            <p class="text-danger text-xs mt-2 mb-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    <div class=" ">
                                        <input type="phone_no" class="form-control " placeholder="Phone Number" aria-label="Email" aria-describedby="email-addon" name="phone_no" id="phone_no" value="{{ old('phone_no') }}" required>
                                        @error('phone_no')
                                            <p class="text-danger text-xs mt-2 mb-2">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="mt-3">
                                    <div class=" ">
                                        <select class="form-control" name="programme_id" id="programme_id">
                                            ...
                                            <option value="1">{{ __('Higher National Diploma') }}</option>
                                            <option value="2">{{ __('National Diploma') }}</option>
                                            <option value="3">{{ __('National Diploma Special') }}</option>
                                            <option value="3">{{ __('Polytechnic Diploma (CCE)') }}</option>
                                        </select>
                                    </div>
                                </div>
