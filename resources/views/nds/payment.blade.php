                                    ...
                                    <div class="col-sm-6">
                                        <div>
                                            ...
                                            <span
                                                ...
                                                {{ auth()->user()->last_name.' '.auth()->user()->first_name. ' '.auth()->user()->middle_name }}</span>
                                        </div>
                                        <div class="text-grey-m2">
                                            ...
                                            <div class="my-1"><i class="fas fa-phone"></i> <b
                                                    class="text-600">{{ auth()->user()->phone_no }}</b></div>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="text-95 text-secondary-d3">
                                        <div class="row mb-2 mb-sm-0 py-25">
                                            ...
                                            <div class="col-2 text-secondary-d2">{{ auth()->user()->phone_no; }}</div>
