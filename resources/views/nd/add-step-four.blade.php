      ...
      <div class="multisteps-form mb-5">
        ...
        <div class="row">
          <div class="col-12 col-lg-8 m-auto">
            <form class="multisteps-form__form mb-8 add-edit-user" method="POST" action="{{route('hnd.validate.step.four')}}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="card multisteps-form__panel p-3 border-radius-xl bg-white js-active" data-animation="FadeIn">
                ...
                <div class="multisteps-form__content mt-3">
                  ...
                  <div class="button-row d-flex mt-4">
                    <a href="{{ route('hnd.create.step.three') }}" class="btn bg-gradient-light mb-0 js-btn-prev">Prev</a>
