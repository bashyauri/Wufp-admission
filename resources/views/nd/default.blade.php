@extends('user_type.auth', ['parentFolder' => 'nd', 'childFolder' => 'none'])
            ...
            <div class="card-body p-1 pt-0">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 my-auto text-end">
                    <a href="{{route('nd.print.form')}}" class="btn bg-gradient-info mb-0">Print Form</a>
                  </div>
                @endcan
                <div class="col-lg-6 col-md-6 col-12 my-auto text-end">
                  <a href="{{route('nd.validate.step.six')}}" class="btn bg-gradient-info mb-0">Go to profile</a>
                </div>
              </div>
